...
public class BlocklingHeldItemLayer extends LayerRenderer<BlocklingEntity, BlocklingModel>
{
    ...
    @Override
    public void render(@Nonnull GuiGraphics matrixStack, @Nonnull IRenderTypeBuffer renderTypeBuffer, int p_225628_3_, @Nonnull BlocklingEntity blockling, float goesUpWhenMovesCouldBeSpeed, float changesWhenMovesCouldBeSwing, float p_225628_7_, float consistentCouldBePartialTicks, float p_225628_9_, float p_225628_10_)
    {
     ...
     * @param p_225628_3_ ???
     */
    private void renderItem(@Nonnull GuiGraphics matrixStack, @Nonnull ItemStack stack, boolean isLeftHand, @Nonnull BlocklingEntity blockling, @Nonnull IRenderTypeBuffer renderTypeBuffer, int p_225628_3_)
    {
        ...
        matrixStack.mulPose(org.joml.Vector3f.YP.rotationDegrees(180.0f));
        matrixStack.mulPose(org.joml.Vector3f.XP.rotationDegrees(190.0f));
     ...
     * @return the additional adjustment to line up the item with blockling's InteractionHand.
     */

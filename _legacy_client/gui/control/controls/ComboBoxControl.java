...
public class ComboBoxControl extends StackPanel
{
    ...
    public static class Item
    {
         ...
         */
        public Item(@Nonnull Component name, @Nonnull Object value, @Nullable List<IReorderingProcessor> tooltip)
        {
         ...
         * @param tooltip the optional tooltip of the item.
         */
        public Item(@Nonnull Component name, @Nonnull Object value, @Nullable Texture iconTexture, @Nullable List<IReorderingProcessor> tooltip)
        {
            this.name = name;
            this.value = value;

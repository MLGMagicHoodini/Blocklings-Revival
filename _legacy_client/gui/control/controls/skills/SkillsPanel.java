    ...
    private class ConfirmationControl extends Control
    {
        ...
        public void setWidth(double width)
        {
            ...
            if (skill != null)
            {
                ...
                for (String line : GuiUtil.get().split(new BlocklingsTranslationTextComponent("skill.buy_confirmation", ChatFormatting.LIGHT_PURPLE + skill.info.general.name.getString() + ChatFormatting.WHITE).getString(), (int) getWidth() - 20))
                {

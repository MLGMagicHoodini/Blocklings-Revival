        ...
        public SimpleItemsConfigurationControl(@Nonnull OrderedItemInfoSet itemInfoSet, boolean isTakeItems)
        {
            ...
            addBackground = new TexturedControl(Textures.Tasks.TASK_ICON_BACKGROUND_RAISED, Textures.Tasks.TASK_ICON_BACKGROUND_PRESSED)
            {
                ...
                public void onRenderTooltip(@Nonnull GuiGraphics matrixStack, double mouseX, double mouseY, float partialTicks)
                {
                    ...
                    tooltip.add(new BlocklingsTranslationTextComponent("config.item.add").withStyle(itemsPanel.getChildren().size() - 1 > getMaxItems() ? ChatFormatting.GRAY : ChatFormatting.WHITE).getVisualOrderText());
                    tooltip.add(new BlocklingsTranslationTextComponent("config.item.amount", itemsPanel.getChildren().size() - 2, getMaxItems()).withStyle(ChatFormatting.GRAY).getVisualOrderText());
            ...
            public AdvancedItemInfoControl(@Nonnull ItemInfo itemInfo)
            {
                ...
                NullableIntFieldControl startInventoryField = new NullableIntFieldControl()
                {
                    ...
                    public void onRenderTooltip(@Nonnull GuiGraphics matrixStack, double mouseX, double mouseY, float partialTicks)
                    {
                        ...
                        tooltip.addAll(GuiUtil.get().split(new BlocklingsTranslationTextComponent("config.item.inventory_start_amount.desc").withStyle(ChatFormatting.GRAY), 200));
                ...
                NullableIntFieldControl startContainerField = new NullableIntFieldControl()
                {
                    ...
                    public void onRenderTooltip(@Nonnull GuiGraphics matrixStack, double mouseX, double mouseY, float partialTicks)
                    {
                        ...
                        tooltip.addAll(GuiUtil.get().split(new BlocklingsTranslationTextComponent("config.item.container_start_amount.desc").withStyle(ChatFormatting.GRAY), 200));
                ...
                NullableIntFieldControl stopInventoryField = new NullableIntFieldControl()
                {
                    ...
                    public void onRenderTooltip(@Nonnull GuiGraphics matrixStack, double mouseX, double mouseY, float partialTicks)
                    {
                        ...
                        tooltip.addAll(GuiUtil.get().split(new BlocklingsTranslationTextComponent("config.item.inventory_stop_amount.desc").withStyle(ChatFormatting.GRAY), 200));
                ...
                NullableIntFieldControl stopContainerField = new NullableIntFieldControl()
                {
                    ...
                    public void onRenderTooltip(@Nonnull GuiGraphics matrixStack, double mouseX, double mouseY, float partialTicks)
                    {
                        ...
                        tooltip.addAll(GuiUtil.get().split(new BlocklingsTranslationTextComponent("config.item.container_stop_amount.desc").withStyle(ChatFormatting.GRAY), 200));

...
public abstract class GuiControl extends AbstractGui
{
     ...
     */
    public void renderRectangle(@Nonnull GuiGraphics matrixStack, double x, double y, int width, int height, int colour)
    {
     ...
     * @param colour the colour of the rectangle.
     */
    public void renderCenteredRectangle(@Nonnull GuiGraphics matrixStack, double x, double y, double width, double height, int colour)
    {
     ...
     */
    protected void renderTexture(@Nonnull GuiGraphics matrixStack, @Nonnull Texture texture)
    {
     ...
     */
    protected void renderTexture(@Nonnull GuiGraphics matrixStack, @Nonnull Texture texture, double x, double y, double scaleX, double scaleY)
    {
     ...
     */
    protected void renderShadowedText(@Nonnull GuiGraphics matrixStack, @Nonnull IReorderingProcessor text, int colour)
    {
     ...
     * @param colour the colour of the text.
     */
    protected void renderShadowedText(@Nonnull GuiGraphics matrixStack, @Nonnull IReorderingProcessor text, int x, int y, int colour)
    {
     ...
     * @param colour the colour of the text.
     */
    protected void renderText(@Nonnull GuiGraphics matrixStack, @Nonnull IReorderingProcessor text, int colour)
    {
     ...
     */
    public void renderTooltip(@Nonnull GuiGraphics matrixStack, double mouseX, double mouseY, double pixelScaleX, double pixelScaleY, @Nonnull Component tooltip)
    {
     ...
     * @param tooltip the tooltip to render.
     */
    public void renderTooltip(@Nonnull GuiGraphics matrixStack, double mouseX, double mouseY, double pixelScaleX, double pixelScaleY, @Nonnull List<IReorderingProcessor> tooltip)
    {

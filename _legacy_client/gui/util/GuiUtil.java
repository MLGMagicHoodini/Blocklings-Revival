...
public abstract class GuiUtil
{
     ...
     */
    public abstract void renderShadowedText(@Nonnull GuiGraphics matrixStack, @Nonnull IReorderingProcessor text, int x, int y, int color);
     ...
     * @param color the color to render the text in.
     */
    public abstract void renderText(@Nonnull GuiGraphics matrixStack, @Nonnull IReorderingProcessor text, int x, int y, int color);
     ...
     */
    public abstract void renderEntityOnScreen(@Nonnull GuiGraphics matrixStack, @Nonnull LivingEntity entity, int screenX, int screenY, float screenMouseX, float screenMouseY, float scale, boolean scaleToBoundingBox);
     ...
     */
    public abstract void renderItemStack(@Nonnull GuiGraphics matrixStack, @Nonnull ItemStack stack, int x, int y, double z, float scale);

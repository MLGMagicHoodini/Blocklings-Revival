...
public class TestGuiUtil extends GuiUtil
{
    ...
    @Override
    public void renderEntityOnScreen(@Nullable GuiGraphics matrixStack, @Nullable LivingEntity entity, int screenX, int screenY, float screenMouseX, float screenMouseY, float scale, boolean scaleToBoundingBox)
    {

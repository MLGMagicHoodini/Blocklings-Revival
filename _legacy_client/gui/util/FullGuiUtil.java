...
public class FullGuiUtil extends GuiUtil
{
    ...
    public ITextProperties trimWithEllipsis(@Nonnull ITextProperties text, int width)
    {
        ...
        {
            return ITextProperties.composite(trim(text, width - mc.font.width("...")), Component.literal("..."));
        }
    }
    ...
    @Override
    public void renderShadowedText(@Nonnull GuiGraphics matrixStack, @Nonnull IReorderingProcessor text, int x, int y, int color)
    {
        mc.font.drawShadow(matrixStack, text, x, y, color);
    }

    @Override
    public void renderText(@Nonnull GuiGraphics matrixStack, @Nonnull IReorderingProcessor text, int x, int y, int color)
    {
    ...
    @Override
    public void renderEntityOnScreen(@Nonnull GuiGraphics matrixStack, @Nonnull LivingEntity entity, int screenX, int screenY, float screenMouseX, float screenMouseY, float scale, boolean scaleToBoundingBox)
    {
        ...
        Quaternion quaternion = org.joml.Vector3f.ZP.rotationDegrees(180.0F);
        Quaternion quaternion1 = org.joml.Vector3f.XP.rotationDegrees(f1 * 20.0F);
    ...
    @Override
    public void renderItemStack(@Nonnull GuiGraphics matrixStack, @Nonnull ItemStack stack, int x, int y, double z, float scale)
    {

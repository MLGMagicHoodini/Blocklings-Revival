...
public class BlocklingsContainerScreen<T extends Container> extends ContainerScreen<T>
{
    ...
    {
        super(container, Minecraft.getInstance().player.inventory, Component.literal(""));
    ...
    @Override
    protected void renderLabels(@Nonnull GuiGraphics matrixStack, int screenMouseX, int screenMouseY)
    {

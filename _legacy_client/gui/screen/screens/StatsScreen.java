    ...
    public StatsScreen(@Nonnull BlocklingEntity blockling)
    {
        ...
        EntityControl entityControl = new EntityControl()
        {
            ...
            public void onRenderTooltip(@Nonnull GuiGraphics matrixStack, double mouseX, double mouseY, float partialTicks)
            {
                ...
                tooltip.add(Component.literal(ChatFormatting.GRAY + new BlocklingsTranslationTextComponent("type.natural.name").getString() + ChatFormatting.WHITE + blockling.getNaturalBlocklingType().name.getString()).getVisualOrderText());
                ...
                tooltip.add(Component.literal(ChatFormatting.GRAY + new BlocklingsTranslationTextComponent("type.name").getString() + ChatFormatting.WHITE + blockling.getBlocklingType().name.getString()).getVisualOrderText());
                ...
                String foodsString = ChatFormatting.GRAY + new BlocklingsTranslationTextComponent("type.foods").getString() + ChatFormatting.WHITE + new BlocklingsTranslationTextComponent("type.foods.flowers").getString() + ", ";
                ...
                if (!GuiUtil.get().isCrouchKeyDown())
                {
                    tooltip.add(Component.literal(ChatFormatting.DARK_GRAY + "" + ChatFormatting.ITALIC + new BlocklingsTranslationTextComponent("gui.more_info", Minecraft.getInstance().options.keyShift.getTranslatedKeyMessage().getString()).getString()).getVisualOrderText());
                }

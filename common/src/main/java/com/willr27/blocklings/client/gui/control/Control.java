...
public class Control extends BaseControl
{
    ...
    @Override
    public void forwardRender(@Nonnull GuiGraphics matrixStack, @Nonnull ScissorStack scissorStack, double mouseX, double mouseY, float partialTicks)
    {
        ...
        matrixStack.pose().translate(0.0f, 0.0f, isDraggingOrAncestor() ? getDraggedControl().getDragZ() : getRenderZ());
    ...
    @Override
    protected void onRenderUpdate(@Nonnull GuiGraphics matrixStack, @Nonnull ScissorStack scissorStack, double mouseX, double mouseY, float partialTicks)
    {
...
//        matrixStack.pose().pushPose();
//        matrixStack.pose().translate(0.0f, 0.0f, 1.0f);
...
//        matrixStack.pose().popPose();
    ...
    protected void renderRectangleAsBackground(@Nonnull GuiGraphics matrixStack, int colour)
    {
        renderRectangle(matrixStack, (int) getPixelX(), (int) getPixelY(), (int) getPixelWidth(), (int) getPixelHeight(), colour);
    }

    protected void renderRectangleAsBackground(@Nonnull GuiGraphics matrixStack, int colour, double dx, double dy, double width, double height)
    {
    ...
    protected void renderBackgroundColour(@Nonnull GuiGraphics matrixStack)
    {
        renderRectangleAsBackground(matrixStack, getBackgroundColourInt());
    }

    protected void renderTextureAsBackground(@Nonnull GuiGraphics matrixStack, @Nonnull Texture texture)
    {
        renderTexture(matrixStack, texture, getPixelX(), getPixelY(), getPixelScaleX(), getPixelScaleY());
    }

    protected void renderTextureAsBackground(@Nonnull GuiGraphics matrixStack, @Nonnull Texture texture, double dx, double dy)
    {
     ...
     */
    public void renderTooltip(@Nonnull GuiGraphics matrixStack, double mouseX, double mouseY, @Nonnull Component tooltip)
    {
     ...
     * @param mouseY the mouse y position.
     */
    public void renderTooltip(@Nonnull GuiGraphics matrixStack, @Nonnull List<? extends Component> tooltip, double mouseX, double mouseY)
    {
        matrixStack.renderTooltip(Minecraft.getInstance().font, tooltip.stream().map(Component::getVisualOrderText).collect(Collectors.toList()), (int) (mouseX / getPixelScaleX()), (int) (mouseY / getPixelScaleY()));
    }
     ...
     * @param tooltip the tooltip to render.
     */
    public void renderTooltip(@Nonnull GuiGraphics matrixStack, double mouseX, double mouseY, @Nonnull List<FormattedCharSequence> tooltip)
    {
        matrixStack.renderTooltip(Minecraft.getInstance().font, tooltip, (int) (mouseX / getPixelScaleX()), (int) (mouseY / getPixelScaleY()));
    }

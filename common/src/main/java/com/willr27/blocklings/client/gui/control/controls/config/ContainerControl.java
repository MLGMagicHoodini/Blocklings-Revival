...
public class ContainerControl extends GridPanel
{
    ...
    public ContainerControl(@Nonnull ContainerInfo containerInfo)
    {
        ...
        TexturedControl iconBackground = new TexturedControl(Textures.Tasks.TASK_ICON_BACKGROUND_RAISED, Textures.Tasks.TASK_ICON_BACKGROUND_PRESSED)
        {
            ...
            {
                renderTooltip(matrixStack, mouseX, mouseY, BlocklingsTranslationTextComponent.create("config.container.remove", new ItemStack(containerInfo.getBlock()).getHoverName().getString()));
            }
        ...
        name.setText(BlocklingsTranslationTextComponent.create("config.container.blank"));
        ...
        sidePriority = new BlockSideSelectionControl()
        {
            ...
            public void onRenderTooltip(@Nonnull GuiGraphics matrixStack, double mouseX, double mouseY, float partialTicks)
            {
                ...
                MutableComponent name = BlocklingsTranslationTextComponent.create("config.container.side_priority.name");
                ...
                if (mouseOverDirection != null)
                {
                    ...
                    {
                        case NORTH:
                            name.append(BlocklingsTranslationTextComponent.create("config.container.side_priority.side", BlocklingsTranslationTextComponent.create("direction.front")));
                            break;
                        case SOUTH:
                            name.append(BlocklingsTranslationTextComponent.create("config.container.side_priority.side", BlocklingsTranslationTextComponent.create("direction.back")));
                            break;
                        case WEST:
                            name.append(BlocklingsTranslationTextComponent.create("config.container.side_priority.side", BlocklingsTranslationTextComponent.create("direction.left")));
                            break;
                        case EAST:
                            name.append(BlocklingsTranslationTextComponent.create("config.container.side_priority.side", BlocklingsTranslationTextComponent.create("direction.right")));
                            break;
                        case UP:
                            name.append(BlocklingsTranslationTextComponent.create("config.container.side_priority.side", BlocklingsTranslationTextComponent.create("direction.top")));
                            break;
                        case DOWN:
                            name.append(BlocklingsTranslationTextComponent.create("config.container.side_priority.side", BlocklingsTranslationTextComponent.create("direction.bottom")));
                            break;
                    }
                }
                ...
                tooltip.addAll(GuiUtil.get().split(BlocklingsTranslationTextComponent.create("config.container.side_priority.desc").withStyle(ChatFormatting.GRAY), 200));
        ...
        rotationQuat.mul(new org.joml.Quaternionf().rotateX((float)Math.toRadians( 30.0f)));
        rotationQuat.mul(new org.joml.Quaternionf().rotateY((float)Math.toRadians(-45.0f)));

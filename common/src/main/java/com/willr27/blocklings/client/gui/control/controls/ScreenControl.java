...
public class ScreenControl extends Control
{
    ...
    /**
     * Mimics {@link Screen#render(GuiGraphics, int, int, float)}.
     */
    public void render(@Nonnull GuiGraphics matrixStack, int screenMouseX, int screenMouseY, float partialTicks)
    {
        ...
        matrixStack.pose().scale(1.0f / guiScale, 1.0f / guiScale, 1.0f);
        ...
        {
            matrixStack.pose().pushPose();
            matrixStack.pose().scale((float) getHoveredControl().getScaleX(), (float) getHoveredControl().getScaleY(), 1.0f);

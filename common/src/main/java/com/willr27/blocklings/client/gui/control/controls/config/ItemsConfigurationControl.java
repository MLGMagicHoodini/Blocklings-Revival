        ...
        public SimpleItemsConfigurationControl(@Nonnull OrderedItemInfoSet itemInfoSet, boolean isTakeItems)
        {
            ...
            addBackground = new TexturedControl(Textures.Tasks.TASK_ICON_BACKGROUND_RAISED, Textures.Tasks.TASK_ICON_BACKGROUND_PRESSED)
            {
                ...
                public void onRenderTooltip(@Nonnull GuiGraphics matrixStack, double mouseX, double mouseY, float partialTicks)
                {
                    ...
                    tooltip.add(BlocklingsTranslationTextComponent.create("config.item.add").withStyle(itemsPanel.getChildren().size() - 1 > getMaxItems() ? ChatFormatting.GRAY : ChatFormatting.WHITE).getVisualOrderText());
                    tooltip.add(BlocklingsTranslationTextComponent.create("config.item.amount", itemsPanel.getChildren().size() - 2, getMaxItems()).withStyle(ChatFormatting.GRAY).getVisualOrderText());
        ...
        private class SimpleItemInfoControl extends ItemInfoControl
        {
            ...
            public SimpleItemInfoControl(@Nonnull ItemInfo itemInfo)
            {
                ...
                TexturedControl itemBackground = new TexturedControl(Textures.Tasks.TASK_ICON_BACKGROUND_RAISED, Textures.Tasks.TASK_ICON_BACKGROUND_PRESSED)
                {
                    ...
                    public void onRenderTooltip(@Nonnull GuiGraphics matrixStack, double mouseX, double mouseY, float partialTicks)
                    {
                        renderTooltip(matrixStack, mouseX, mouseY, BlocklingsTranslationTextComponent.create("config.item.remove", new ItemStack(itemInfo.getItem()).getHoverName().getString()));
                    }
    ...
    public static class AdvancedItemsConfigurationControl extends ItemsConfigurationControl
    {
        ...
        private class AdvancedItemInfoControl extends ItemInfoControl
        {
            ...
            public AdvancedItemInfoControl(@Nonnull ItemInfo itemInfo)
            {
                ...
                startText.setText(BlocklingsTranslationTextComponent.create("config.item.start_at"));
                ...
                NullableIntFieldControl startInventoryField = new NullableIntFieldControl()
                {
                    ...
                    {
                        List<FormattedCharSequence> tooltip = new ArrayList<>();
                        tooltip.add(BlocklingsTranslationTextComponent.create("config.item.inventory_start_amount.name").getVisualOrderText());
                        tooltip.addAll(GuiUtil.get().split(BlocklingsTranslationTextComponent.create("config.item.inventory_start_amount.desc").withStyle(ChatFormatting.GRAY), 200));
                ...
                NullableIntFieldControl startContainerField = new NullableIntFieldControl()
                {
                    ...
                    {
                        List<FormattedCharSequence> tooltip = new ArrayList<>();
                        tooltip.add(BlocklingsTranslationTextComponent.create("config.item.container_start_amount.name").getVisualOrderText());
                        tooltip.addAll(GuiUtil.get().split(BlocklingsTranslationTextComponent.create("config.item.container_start_amount.desc").withStyle(ChatFormatting.GRAY), 200));
                ...
                stopText.setText(BlocklingsTranslationTextComponent.create("config.item.stop_at"));
                ...
                NullableIntFieldControl stopInventoryField = new NullableIntFieldControl()
                {
                    ...
                    {
                        List<FormattedCharSequence> tooltip = new ArrayList<>();
                        tooltip.add(BlocklingsTranslationTextComponent.create("config.item.inventory_stop_amount.name").getVisualOrderText());
                        tooltip.addAll(GuiUtil.get().split(BlocklingsTranslationTextComponent.create("config.item.inventory_stop_amount.desc").withStyle(ChatFormatting.GRAY), 200));
                ...
                NullableIntFieldControl stopContainerField = new NullableIntFieldControl()
                {
                    ...
                    {
                        List<FormattedCharSequence> tooltip = new ArrayList<>();
                        tooltip.add(BlocklingsTranslationTextComponent.create("config.item.container_stop_amount.name").getVisualOrderText());
                        tooltip.addAll(GuiUtil.get().split(BlocklingsTranslationTextComponent.create("config.item.container_stop_amount.desc").withStyle(ChatFormatting.GRAY), 200));

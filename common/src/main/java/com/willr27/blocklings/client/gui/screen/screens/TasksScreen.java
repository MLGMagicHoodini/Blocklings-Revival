...
public class TasksScreen extends TabbedScreen
{
    ...
    public TasksScreen(@Nonnull BlocklingEntity blockling)
    {
        ...
        TexturedControl addTaskButton = new TexturedControl(Textures.Common.PLUS_ICON)
        {
            ...
            public void onRenderTooltip(@Nonnull GuiGraphics matrixStack, double mouseX, double mouseY, float partialTicks)
            {
                ...
                tooltip.add(BlocklingsTranslationTextComponent.create("task.ui.add").withStyle(blockling.getTasks().isTaskListFull() ? ChatFormatting.GRAY : ChatFormatting.WHITE).getVisualOrderText());
                tooltip.add(BlocklingsTranslationTextComponent.create("task.ui.task_amount", blockling.getTasks().getPrioritisedTasks().size(), BlocklingTasks.MAX_TASKS).withStyle(ChatFormatting.GRAY).getVisualOrderText());
    ...
    private void initConfigTabs(@Nonnull Task task)
    {
        ...
        BaseControl miscContainer = configTabbedPanel.addTab(BlocklingsTranslationTextComponent.create("task.ui.tab.misc"));
        ...
        taskTypeTextBlock.setText(BlocklingsTranslationTextComponent.create("task.ui.task_type").getString());

...
public class Textures
{
    ...
    {
        public static final ResourceLocation TABS = BlocklingsResourceLocation.of("textures/gui/tabs.png");
    ...
    {
        public static final ResourceLocation STATS = BlocklingsResourceLocation.of("textures/gui/stats.png");
    ...
    {
        public static final ResourceLocation TASKS = BlocklingsResourceLocation.of("textures/gui/tasks.png");
        public static final ResourceLocation TASKS_CONFIG = BlocklingsResourceLocation.of("textures/gui/task_configure.png");
        public static final ResourceLocation WHITELIST = BlocklingsResourceLocation.of("textures/gui/whitelist.png");
    ...
    {
        public static final ResourceLocation EQUIPMENT = BlocklingsResourceLocation.of("textures/gui/equipment.png");
        public static final Texture BACKGROUND = new Texture(EQUIPMENT, 0, 0, 176, 166);
    }

    public static class Skills
    {
        public static final ResourceLocation SKILLS = BlocklingsResourceLocation.of("textures/gui/skills.png");
        ...
        public static class Tiles
        {
            ...
            {
                this.location = BlocklingsResourceLocation.of(path);
            }

            public Texture randomTile(@Nonnull Random random)
            {
                return new Texture(location, random.nextInt(256 / TILE_SIZE) * TILE_SIZE, random.nextInt(256 / TILE_SIZE) * TILE_SIZE, TILE_SIZE, TILE_SIZE);
            }
        }
    }
}

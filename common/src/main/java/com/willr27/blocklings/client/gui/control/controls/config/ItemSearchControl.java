...
class ItemSearchControl extends GridPanel
{
    ...
    public ItemSearchControl()
    {
        ...
        tooManyResultsMessage.setText(BlocklingsTranslationTextComponent.create("config.search.too_many_results"));
    ...
    private void updateItems(@Nonnull String searchText)
    {
        ...
        Iterable<Item> items = searchableItems == null ? BuiltInRegistries.ITEM : searchableItems;

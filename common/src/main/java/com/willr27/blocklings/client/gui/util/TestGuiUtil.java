...
public class TestGuiUtil extends GuiUtil
{
    ...
    @Override
    public void renderEntityOnScreen(@Nullable GuiGraphics guiGraphics, @Nullable LivingEntity entity, int screenX, int screenY, float screenMouseX, float screenMouseY, float scale, boolean scaleToBoundingBox, boolean faceCamera, boolean centerVertically)
    {
    }

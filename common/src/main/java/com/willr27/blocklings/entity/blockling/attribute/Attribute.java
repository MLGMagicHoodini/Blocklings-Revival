...
public abstract class Attribute<T> implements IReadWriteNBT
{
    ...
    public Attribute(@Nonnull String id, @Nonnull String key, @Nonnull BlocklingEntity blockling, @Nullable Function<T, String> displayStringValueFunction, @Nullable Supplier<String> displayStringNameSupplier, boolean isEnabled)
    {
        ...
        this.displayStringValueFunction = displayStringValueFunction == null
                ? value -> formatDisplayValue(value, "%.1f")
                : displayStringValueFunction;
    ...
    {
        return formatDisplayValue(getValue(), format);
    }

    @Nonnull
    protected static String formatDisplayValue(@Nullable Object value, @Nonnull String format)
    {
        if (value == null)
        {
        ...
        if (value instanceof Number number)
        {
            ...
            return String.format(format, numeric);
        }
    ...
    {
        return BlocklingsTranslationTextComponent.of("attribute." + this.key + "." + key, objects);
    }

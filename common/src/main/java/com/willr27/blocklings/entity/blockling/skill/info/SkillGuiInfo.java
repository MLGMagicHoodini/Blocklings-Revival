...
public class SkillGuiInfo
{
    ...
    public static class SkillIconTexture extends Texture
    {
        ...
        /**
         * @param tiles the skill tile sheet.
         * @param x the texture x index.
         * @param y the texture y index.
         */
        public SkillIconTexture(@Nonnull Textures.Skills.Tiles tiles, int x, int y)
        {
            super(tiles.location, x * ICON_SIZE, y * ICON_SIZE, ICON_SIZE, ICON_SIZE);
        }
    }

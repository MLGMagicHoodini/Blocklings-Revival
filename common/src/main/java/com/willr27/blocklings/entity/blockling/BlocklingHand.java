...
public enum BlocklingHand
{
    ...
    /**
     * @param main whether to include the main InteractionHand.
     * @param off whether to include the off InteractionHand.
     * @return the InteractionHand equivalent to the given booleans.
     */
    @Nonnull

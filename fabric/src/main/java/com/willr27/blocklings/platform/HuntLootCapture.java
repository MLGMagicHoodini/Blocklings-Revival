 ...
 * <p>
 * Must live OUTSIDE the {@code com.willr27.blocklings.mixin} package: classes in a declared
 * mixin package cannot be referenced directly at runtime (Mixin throws IllegalClassLoadError).
 */

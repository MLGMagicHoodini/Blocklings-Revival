...
public class BlocklingType
{
     ...
     */
    @SafeVarargs
    private static boolean isInWorld(@Nonnull BlocklingEntity blockling, @Nonnull IWorld world, @Nonnull RegistryKey<Level>... worldTypes)
    {
        for (RegistryKey<Level> worldType : worldTypes)
        {
